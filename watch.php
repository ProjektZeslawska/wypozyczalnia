...
<div class="watchContainer">
    ...
    <div class="videoControls watchNav">
        ...
        <button id="buttonFavourite" class='buttonFavourite'
                onclick="toggleColor(<?php echo $video->getId() ?>, '<?php echo $loggedIn ?>')">
...
<script>
    initVideo("<?php echo $video->getId(); ?>", "<?php echo $loggedIn; ?>");
</script>